...
namespace MernisService
{
    ...
    public interface KPSPublicSoap
    {
        ...
        MernisService.TCKimlikNoDogrulaResponse TCKimlikNoDogrula(MernisService.TCKimlikNoDogrulaRequest request);
    ...
    public partial class KPSPublicSoapClient : System.ServiceModel.ClientBase<MernisService.KPSPublicSoap>, MernisService.KPSPublicSoap
    {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        MernisService.TCKimlikNoDogrulaResponse MernisService.KPSPublicSoap.TCKimlikNoDogrula(MernisService.TCKimlikNoDogrulaRequest request)
        {
        ...
        public bool TCKimlikNoDogrula(long TCKimlikNo, string Ad, string Soyad, int DogumYili)
        {
            ...
            MernisService.TCKimlikNoDogrulaResponse retVal = ((MernisService.KPSPublicSoap)(this)).TCKimlikNoDogrula(inValue);
        ...
        internal bool TCKimlikNoDogrula(object nationalyId, string v1, string v2, int year)
        {
            throw new NotImplementedException();
        }
